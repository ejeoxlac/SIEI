...
CTkButton (frame, text='Registro de equipos informáticos', image=image1, corner_radius=15).pack (pady=15)

CTkButton (frame, text='Asignación de los equipos', image=image1, corner_radius=15).pack (pady=15)

CTkButton (frame, text='Vista de registros guardados', image=image2, corner_radius=15).pack (pady=15)

CTkButton (frame, text='Administrador de usuarios', image=image3, corner_radius=15).pack (pady=15)

CTkButton (frame, text='Salir', image=image4, corner_radius=15).pack (pady=15)
